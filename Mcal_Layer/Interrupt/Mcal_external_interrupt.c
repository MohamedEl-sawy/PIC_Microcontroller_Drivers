...
static Std_ReturnType Interrupt_INTx_Priority_Enable(const interrupt_intx_t *int_obj);
static Std_ReturnType Interrupt_INTx_Edge_Init(const interrupt_intx_t *int_obj);
static Std_ReturnType Interrupt_Pin_Init(const interrupt_intx_t *int_obj);
...
Std_ReturnType interrupt_intx_init(const interrupt_intx_t *int_obj)
{
    ...
    else
    {
        ...
        ret = Interrupt_Pin_Init(int_obj);
